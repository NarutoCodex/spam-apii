...
def AuToUpDaTE():
    ...
    url = f"https://play.google.com/store/apps/details?id={package_name}&hl=ar&gl=DZ"
    ...
    api_url = (
        ...
        "&device_name=Samsung%20SM-S918B"
        "&device_CPU=ARM64%20FP%20ASIMD%20AES"
        "&device_GPU=Adreno%20(TM)%20740"
        "&device_mem=8192"
    )
    ...
    url_value = data.get("server_url") or data.get("cdn_url") or "N/A"
    ob_version = data.get("latest_release_version", "N/A")

    return url_value, ob_version, playstore_version
